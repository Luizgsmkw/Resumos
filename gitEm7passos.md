...
2. Após commitar seu arquivo é o momento de envia-lo para o GitHub, mas primeiro você precisa criar um repositório remoto, para realizar essa ação é só utilizar o comando: git remote add nomeDoRepositorio URL   / Ex: git remote add origin /;  
